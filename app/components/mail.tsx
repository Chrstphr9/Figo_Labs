      ...
      <div className="w-full max-w-[1440px] mx-auto px-4 sm:px-6 lg:px-8 py-12 md:py-24">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="text-white space-y-6">
            <h2 className="text-4xl sm:text-5xl lg:text-[36px] font-medium font-sf leading-tight">
              &quot;We keep customers<br />
              at ease while driving<br />
              business success&quot;.
            </h2>
            
            <p className="text-gray-400 text-[16px] font-light font-sf leading-relaxed max-w-lg">
            ...
            <button className="inline-flex items-center space-x-2 gradient-btn hover:from-purple-700 hover:to-blue-700 text-white font-semibold px-4 py-2 rounded-lg transition-all duration-200 transform hover:scale-105 group border-1 border-[#ffffff66]">
